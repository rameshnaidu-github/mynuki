  ...
  return (
    <div>
      ...
      <section className="relative h-[calc(100svh-60px)] min-h-[560px] overflow-hidden">
        {/* The frame matches the artwork's own box, so the sky overlays sit in
            percentages of the painting rather than of the screen. */}
        ...
        <div className="absolute inset-0">
          <div className="max-w-[1352px] mx-auto h-full px-[5.5%] flex items-center">
            {/* The card keeps its own box: px/py are percentages of THIS parent,
                so wrapping it in anything narrower would shrink its padding. */}
            <div
              className="hero-card w-[74%] sm:w-[52%] md:w-[41%] max-w-[545px] md:aspect-[545/742]
                         max-h-[calc(100svh-120px)] bg-heroblock/[0.88] border-[3px] border-gold
                         rounded-[22px] px-[9%] py-[8%] flex flex-col justify-center gap-[10%]"
            >
